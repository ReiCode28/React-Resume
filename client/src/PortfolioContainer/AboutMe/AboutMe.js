  ...
  const SCREEN_CONSTANTS = {
    ...
    highlights: {
      bullets: [
        ...
        "Strong creativity, problem-solving and critical thinking skills",
        "Ability to manage projects, mentor and help others",
      ],
        ...
        <div className="about-me-card">
          ...
          <div className="about-me-details">
            ...
            <div className="about-me-options">
              ...
              <a
                href="RandyR_ResumeUpdated.pdf"
                download="RandyR_ResumeUpdated.pdf"
              >
